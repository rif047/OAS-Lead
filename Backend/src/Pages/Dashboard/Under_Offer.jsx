...
export default function Under_Offer() {
    ...
    useEffect(() => {
        const fetchProperties = async () => {
            try {
                ...
                const letProperties = data.filter(p => p.status === "Offering");
    ...
    return (
        <div className="">
            <h2 className="font-bold bg-[#4c5165] px-3 py-3 text-gray-200 rounded-t-lg">Under Offer Properties: {total}</h2>
            <div className='p-6'>
                <h3 className="mb-6 text-gray-700">Recent Under Offer Properties:</h3>
