...
export default function Property() {
    ...
    useEffect(() => {
        const fetchProperties = async () => {
            try {
                ...
                const letProperties = data.filter(p => p.status === "Pending");
    ...
    return (
        <div className="">
            <h2 className="font-bold bg-[#4c5165] px-3 py-3 text-gray-200 rounded-t-lg">Pending Properties: {total}</h2>
            <div className='p-6'>
                <h3 className="mb-6 text-gray-700">Recent Pending Properties:</h3>
